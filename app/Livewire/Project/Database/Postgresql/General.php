...
class General extends Component
{
    ...
    protected $validationAttributes = [
        'name' => '名称',
        'description' => '描述',
        'postgresUser' => 'Postgres 用户',
        'postgresPassword' => 'Postgres 密码',
        'postgresDb' => 'Postgres 数据库',
        'postgresInitdbArgs' => 'Postgres Initdb 参数',
        'postgresHostAuthMethod' => 'Postgres 主机认证方式',
        'postgresConf' => 'Postgres 配置',
        'initScripts' => '初始化脚本',
        'image' => '镜像',
        'portsMappings' => '端口映射',
        'isPublic' => '是否公开',
