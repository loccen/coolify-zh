...
class General extends Component
{
    ...
    protected $validationAttributes = [
        ...
        'dockerRegistryImageName' => 'Docker 注册表镜像名称',
        'dockerRegistryImageTag' => 'Docker 注册表镜像标签',
        'dockerfileLocation' => 'Dockerfile 路径',
        'dockerComposeLocation' => 'Docker Compose 路径',
        'dockerCompose' => 'Docker Compose',
        'dockerComposeRaw' => 'Docker Compose 原文',
        'customLabels' => '自定义标签',
        'dockerfileTargetBuild' => 'Dockerfile 构建目标',
        'customDockerRunOptions' => '自定义 Docker 运行选项',
        'customNetworkAliases' => '自定义 Docker 网络别名',
        'dockerComposeCustomStartCommand' => 'Docker Compose 自定义启动命令',
        'dockerComposeCustomBuildCommand' => 'Docker Compose 自定义构建命令',
        'customNginxConfiguration' => '自定义 Nginx 配置',
        'isStatic' => '静态站点',
        'isSpa' => '单页应用',
        'isBuildServerEnabled' => '构建服务器',
        'isContainerLabelEscapeEnabled' => '容器标签转义',
        'isContainerLabelReadonlyEnabled' => '容器标签只读',
        'isPreserveRepositoryEnabled' => '保留仓库',
        'watchPaths' => '监听路径',
        'redirect' => '重定向',
    ];
