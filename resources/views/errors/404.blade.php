...
<div class="flex flex-col items-center justify-center h-full">
    <div>
        ...
        <h1 class="mt-4 font-bold tracking-tight dark:text-white">{{ __('How did you get here?') }}</h1>
        <p class="text-base leading-7 dark:text-neutral-400 text-black">{{ __("Sorry, we couldn't find the page you're looking for.") }}
        </p>
