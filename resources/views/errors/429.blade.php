...
<div class="flex flex-col items-center justify-center h-full">
    <div>
        ...
        <h1 class="mt-4 font-bold tracking-tight dark:text-white">{{ __('Woah, slow down there!') }}</h1>
        <p class="text-base leading-7 dark:text-neutral-400 text-black">{{ __("You're making too many requests. Please wait a few seconds before trying again.") }}
        </p>
