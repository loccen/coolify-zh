<nav class="flex flex-col flex-1 bg-white border-r dark:border-coolgray-200 border-neutral-300 dark:bg-base"
    ...
    <div class="flex pt-4 pb-4 pl-2 items-start gap-2 motion-safe:transition-all motion-safe:duration-200 motion-safe:ease-out motion-reduce:transition-none"
        ...
        <div class="flex flex-col w-full" :class="collapsed && 'lg:hidden'">
            <a href="/" {{ wireNavigate() }} class="text-2xl font-bold tracking-tight dark:text-white hover:opacity-80 transition-opacity">{{ __('navigation.brand') }}</a>
            <x-version />
        </div>
        <div class="hidden flex-col items-center w-full gap-1"
            ...
            <a href="/" {{ wireNavigate() }}
                ...
                <img src="/coolify-logo.svg" alt="{{ __('navigation.brand') }}" class="w-6 h-6" />
            </a>
        ...
        <div :class="collapsed && 'lg:hidden'">
            ...
            <button @click="$dispatch('open-global-search')" type="button"
                title="{{ __('navigation.search_shortcut') }}"
                aria-label="{{ __('navigation.search_shortcut') }}"
        ...
        <li class="flex-1 overflow-x-hidden">
            <ul role="list" class="flex flex-col h-full space-y-1.5">
                @if (isSubscribed() || !isCloud())
                    <li>
                        <a title="{{ __('navigation.dashboard') }}" href="/" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.dashboard') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.projects') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.projects') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.servers') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.servers') }}</span>
                        </a>
                    </li>

                    <li>
                        <a title="{{ __('navigation.sources') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.sources') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.destinations') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.destinations') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.s3_storages') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.s3_storages') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.shared_variables') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.shared_variables') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.notifications') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.notifications') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.keys_tokens') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.keys_tokens') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.tags') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.tags') }}</span>
                        </a>
                    </li>
                    @can('canAccessTerminal')
                        <li>
                            <a title="{{ __('navigation.terminal') }}"
                                ...
                                <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.terminal') }}</span>
                            </a>
                        </li>
                    @endcan
                    <li>
                        <a title="{{ __('navigation.profile') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.profile') }}</span>
                        </a>
                    </li>
                    <li>
                        <a title="{{ __('navigation.teams') }}" {{ wireNavigate() }}
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.teams') }}</span>
                        </a>
                    </li>
                    @if (isCloud() && auth()->user()->isAdmin())
                        <li>
                            <a title="{{ __('navigation.subscription') }}" {{ wireNavigate() }}
                                ...
                                <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.subscription') }}</span>
                            </a>
                        </li>
                    @endif
                    @if (isInstanceAdmin())
                        <li>
                            ...
                            <a title="{{ __('navigation.settings') }}" {{ wireNavigate() }}
                                ...
                                <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.settings') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (isCloud() || isDev())
                        @if (isInstanceAdmin() || session('impersonating'))
                            <li>
                                <a title="{{ __('navigation.admin') }}" class="menu-item" href="/admin" {{ wireNavigate() }}>
                                    ...
                                    <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.admin') }}</span>
                                </a>
                            </li>
                        @endif
                    @endif
                    ...
                    <li>
                        <a title="{{ __('navigation.sponsor_us') }}" class="menu-item" href="https://coolify.io/sponsorships"
                            target="_blank">
                            ...
                            <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.sponsor_us') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @endif
                <li>
                    <x-modal-input :title="__('navigation.help_title')">
                        <x-slot:content>
                            <div title="{{ __('navigation.help_tooltip') }}" class="cursor-pointer menu-item"
                                wire:click="help">
                                <svg class="menu-item-icon" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                ...
                                <span class="menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('navigation.feedback') }}</span>
                            </div>
                        </x-slot:content>
                        <livewire:help />
                    </x-modal-input>
                ...
                <li>
                    <form action="/logout" method="POST">
                        @csrf
                        <button title="{{ __('auth.logout') }}" type="submit" class="gap-2 mb-6 menu-item">
                            <svg class="menu-item-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path fill="currentColor"
                            ...
                            <span class="text-left menu-item-label" :class="collapsed && 'lg:hidden'">{{ __('auth.logout') }}</span>
                        </button>
                    </form>
                </li>
            </ul>
