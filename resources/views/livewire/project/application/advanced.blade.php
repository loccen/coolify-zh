<div>
    <div class="flex flex-col md:w-96">
        ...
        <div class="flex flex-col gap-1 pt-4">
            ...
            <x-forms.checkbox
                :helper="__('The deployed container will have the same name (:name). <span class=\\'font-bold dark:text-warning\\'>You will lose the rolling update feature!</span>', ['name' => $application->uuid])"
            ...
            @if ($isConsistentContainerNameEnabled === false)
                <form class="flex items-end gap-2 " wire:submit.prevent='saveCustomName'>
                    <x-forms.input
                        :helper="__('You can add a custom name for your container.<br><br>The name will be converted to slug format when you save it. <span class=\\'font-bold dark:text-warning\\'>You will lose the rolling update feature!</span>')"
            ...
            @if ($application->git_based())
                ...
                <x-forms.checkbox
                    :helper="__('Allow to automatically deploy Preview Deployments for all opened PR\\'s.<br><br>Closing a PR will delete Preview Deployments.')"
    ...
    <form wire:submit="submit" class="flex flex-col gap-2">
        ...
        @if ($application->build_pack !== 'dockercompose')
            <div class="md:w-96 pb-4">
                <x-forms.checkbox
                    :helper="__('Enable GPU usage for this application. More info <a href=\\'https://docs.docker.com/compose/gpu-support/\\' class=\\'underline dark:text-white\\' target=\\'_blank\\'>here</a>.')"
        ...
        @if ($isGpuEnabled)
            <div class="flex flex-col w-full gap-2 ">
                ...
                <x-forms.input :label="__('GPU Device Ids')" placeholder="0,2"
                    :helper="__('Comma separated list of device ids. More info <a href=\\'https://docs.docker.com/compose/gpu-support/#access-specific-devices\\' class=\\'underline dark:text-white\\' target=\\'_blank\\'>here</a>.')"
