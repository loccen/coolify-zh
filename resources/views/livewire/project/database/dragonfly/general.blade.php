<div>
    <form wire:submit="submit" class="flex flex-col gap-2">
        ...
        @if ($database->started_at)
            <div class="flex gap-2">
                <x-forms.input :label="__('Initial Password')" id="dragonflyPassword" type="password" required readonly
        ...
        @else
            ...
            <div class="flex gap-2">
                <x-forms.input :label="__('Password')" id="dragonflyPassword" type="password" required canGate="update"
        ...
        <div class="flex flex-col gap-2">
            ...
            <x-forms.input :label="__('Dragonfly URL (internal)')"
            ...
            @if ($dbUrlPublic)
                <x-forms.input :label="__('Dragonfly URL (public)')"
                    :helper="__('If you change the user/password/port, this could be different. This is with the default values.')"
