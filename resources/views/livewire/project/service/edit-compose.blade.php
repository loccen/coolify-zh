<div x-data="{
    ...
    <div class="pb-4">{{ __('Volume names are updated upon save. The service UUID will be added as a prefix to all volumes to prevent name collisions.<br>To see the actual volume names, check the Deployable Compose file or go to the Storage menu.') }}</div>
    ...
    <div class="pt-2 flex gap-2">
        <div class="flex flex-col gap-2">
            ...
            <x-forms.checkbox :label="__('Show Normal Textarea')" x-model="showNormalTextarea"></x-forms.checkbox>
        </div>
