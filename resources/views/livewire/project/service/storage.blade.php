    ...
    @if (
        ...
        <div>
            <div class="flex items-center gap-2">
                <h2>{{ __('Storages') }}</h2>
                <x-helper
                    :helper="__('For Preview Deployments, storage has a <span class=\'text-helper\'>-pr-#PRNumber</span> in their volume name, example: <span class=\'text-helper\'>-pr-1</span>')" />
                                ...
                                <div x-show="volumeModalOpen" @keydown.window.escape="volumeModalOpen=false"
                                    ...
                                    <div x-show="volumeModalOpen" x-trap.inert.noscroll="volumeModalOpen"
                                        ...
                                        <div class="flex items-center justify-between pb-3">
                                            <h3 class="text-2xl font-bold">{{ __('Add Volume Mount') }}</h3>
                                        ...
                                        <div class="relative flex items-center justify-center w-auto"
                                            ...
                                            <form class="flex flex-col w-full gap-2 rounded-sm"
                                                ...
                                                <div class="flex flex-col">
                                                    <div>{{ __('Docker Volumes mounted to the container.') }}</div>
                                                </div>
                                                @if ($isSwarm)
                                                    <div class="text-warning">{{ __('Swarm Mode detected: You need to set a shared volume (EFS/NFS/etc) on all the worker nodes if you would like to use persistent volumes.') }}</div>
                                                @endif
                            ...
                            <template x-teleport="body">
                                <div x-show="fileModalOpen" @keydown.window.escape="fileModalOpen=false"
                                    ...
                                    <div x-show="fileModalOpen" x-trap.inert.noscroll="fileModalOpen"
                                        ...
                                        class="relative w-full py-6 border rounded-sm drop-shadow-sm min-w-full lg:min-w-[36rem] max-w-fit bg-white border-neutral-200 dark:bg-base px-6 dark:border-coolgray-300">
                                        <div class="flex items-center justify-between pb-3">
                                            <h3 class="text-2xl font-bold">{{ __('Add File Mount') }}</h3>
                                        ...
                                        <div class="relative flex items-center justify-center w-auto"
                                            ...
                                            <form class="flex flex-col w-full gap-2 rounded-sm"
                                                ...
                                                <div class="flex flex-col">
                                                    <div>{{ __('Actual file mounted from the host system to the container.') }}</div>
                                                </div>
                                                <div class="flex flex-col gap-2">
                                                    <x-forms.input canGate="update" :canResource="$resource"
                            ...
                            <template x-teleport="body">
                                <div x-show="directoryModalOpen" @keydown.window.escape="directoryModalOpen=false"
                                    ...
                                    <div x-show="directoryModalOpen" x-trap.inert.noscroll="directoryModalOpen"
                                        ...
                                        class="relative w-full py-6 border rounded-sm drop-shadow-sm min-w-full lg:min-w-[36rem] max-w-fit bg-white border-neutral-200 dark:bg-base px-6 dark:border-coolgray-300">
                                        <div class="flex items-center justify-between pb-3">
                                            <h3 class="text-2xl font-bold">{{ __('Add Directory Mount') }}</h3>
                                        ...
                                        <div class="relative flex items-center justify-center w-auto"
                                            ...
                                            <form class="flex flex-col w-full gap-2 rounded-sm"
                                                ...
                                                <div class="flex flex-col">
                                                    <div>{{ __('Directory mounted from the host system to the container.') }}</div>
                                                </div>
                                                <div class="flex flex-col gap-2">
                                                    <x-forms.input canGate="update" :canResource="$resource"
            ...
            <div>{{ __('Persistent storage to preserve data between deployments.') }}</div>
        </div>
