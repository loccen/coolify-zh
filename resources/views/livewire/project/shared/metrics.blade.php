<div>
    ...
    <div>
        ...
        @elseif(!$resource->destination->server->isMetricsEnabled())
            <div class="alert alert-warning pb-1">{{ __('Metrics are only available for servers with Sentinel & Metrics enabled!') }}</div>
            <div>{{ __('Go to') }} <a class="underline dark:text-white" href="{{ route('server.show', $resource->destination->server->uuid) }}/sentinel" {{ wireNavigate() }}>{{ __('Server settings') }}</a> {{ __('to enable it.') }}</div>
        @else
                             ...
                             tooltip: {
                                 ...
                                 custom: function({ series, seriesIndex, dataPointIndex, w }) {
                                     ...
                                     return '<div class="apexcharts-tooltip-custom">' +
                                         '<div class="apexcharts-tooltip-custom-value">' + @js(__('CPU')) + ': <span class="apexcharts-tooltip-value-bold">' + value + '%</span></div>' +
                             ...
                             tooltip: {
                                 ...
                                 custom: function({ series, seriesIndex, dataPointIndex, w }) {
                                     ...
                                     const timeString = String(date.getUTCHours()).padStart(2, '0') + ':' +
                                         ...
                                         String(date.getUTCDate()).padStart(2, '0');
                                     return '<div class="apexcharts-tooltip-custom">' +
                                         '<div class="apexcharts-tooltip-custom-value">' + @js(__('Memory')) + ': <span class="apexcharts-tooltip-value-bold">' + value + ' MB</span></div>' +
                                         '<div class="apexcharts-tooltip-custom-title">' + timeString + '</div>' +
                                         '</div>';
                                 }
                             },
