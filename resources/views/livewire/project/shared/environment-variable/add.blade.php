<form class="flex flex-col w-full gap-2 rounded-sm" wire:submit='submit'
    ...
    @if (!$shared)
        ...
        <x-forms.checkbox id="is_literal"
            :helper="__('This means that when you use $VARIABLES in a value, it should be interpreted as the actual characters \\'$VARIABLES\\' and not as the value of a variable named VARIABLE.<br><br>Useful if you have $ sign in your value and there are some characters after it, but you would not like to interpolate it from another value. In this case, you should set this to true.')"
            :label="__('Is Literal?')" />
    @endif
